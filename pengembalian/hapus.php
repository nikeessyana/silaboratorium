...
if(isset($_GET['id'])){
	...
	$cek = mysql_query("SELECT id_peminjaman FROM peminjaman WHERE id_peminjaman='$id_dtl_aset'") or die(mysql_error());
	...
	if(mysql_num_rows($cek) == 0){
		...
		$del = mysql_query("DELETE FROM peminjaman WHERE id_peminjaman='$id_dtl_aset'");
