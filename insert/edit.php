...
if(isset($_GET['id_pengguna']))
{
  ...
  $updated=mysql_query("UPDATE pengguna SET 
		 alamat='$ealamat', no_telp='$eno_telp', status_pengguna='$estatus_pengguna', username='$enama_pengguna', password='$epassword',level='$elevel' WHERE id_pengguna='$id_pengguna'")or die();
  if($updated)
  {
...
<?php 
  ...
  while($profile=mysql_fetch_array($getselect))
  {
	...
	$nama_pengguna=$profile['username'];
...
<div class="display">
  <form action="" method="post" name="insertform">
	...
	<p>
      <label for="nama_pengguna"  id="preinput"> USERNAME : </label>
	...
	<p>
      ...
      <input type="text" name="elevel" required placeholder="Enter your level" 
      value="<?php echo $level; ?>" id="inputid" />
    </p>
    <p>
